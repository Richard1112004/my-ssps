...
const documents = [
  {
    id: '0000001',
    name: 'Admin',
    email: 'admin.spso@hcmut.edu.vn',
    phone: '035266xxxx',
  },
  {
    id: '2211927',
    name: 'Nguyễn Khánh Lộc',
    email: 'loc.nguyenkhanh@hcmut.edu.vn',
    phone: '034949xxxx',
  },
  {
    id: '2211928',
    name: 'Trần Văn An',
    email: 'an.tranvan@hcmut.edu.vn',
    phone: '034556xxxx',
  },
  {
    id: '2211929',
    name: 'Lê Thị Thanh',
    email: 'thanh.lethithanh@hcmut.edu.vn',
    phone: '035667xxxx',
  },
  {
    id: '2211930',
    name: 'Phạm Quốc Bảo',
    email: 'bao.phamquoc@hcmut.edu.vn',
    phone: '036778xxxx',
  },
  {
    id: '2211931',
    name: 'Ngô Thị Hạnh',
    email: 'hanh.ngothi@hcmut.edu.vn',
    phone: '037889xxxx',
  },
  {
    id: '2211932',
    name: 'Vũ Minh Quân',
    email: 'quan.vuminh@hcmut.edu.vn',
    phone: '038990xxxx',
  },
  {
    id: '2211933',
    name: 'Phạm Thị Hòa',
    email: 'hoa.phamthi@hcmut.edu.vn',
    phone: '039101xxxx',
  },
  {
    id: '2211934',
    name: 'Đinh Văn Tài',
    email: 'tai.dinhvan@hcmut.edu.vn',
    phone: '032233xxxx',
  },
  {
    id: '2211935',
    name: 'Trần Ngọc Phúc',
    email: 'phuc.tranngoc@hcmut.edu.vn',
    phone: '033344xxxx',
  },
  {
    id: '2211936',
    name: 'Nguyễn Văn Tiến',
    email: 'tien.nguyenvan@hcmut.edu.vn',
    phone: '034455xxxx',
  },
  {
    id: '2211937',
    name: 'Lê Minh Huy',
    email: 'huy.leminh@hcmut.edu.vn',
    phone: '035566xxxx',
  },
  {
    id: '2211938',
    name: 'Trần Thị Thu',
    email: 'thu.tranthi@hcmut.edu.vn',
    phone: '036677xxxx',
  },
  {
    id: '2211939',
    name: 'Ngô Văn Hoàng',
    email: 'hoang.ngovan@hcmut.edu.vn',
    phone: '037788xxxx',
  },
  {
    id: '2211940',
    name: 'Nguyễn Thị Ngọc',
    email: 'ngoc.nguyenthi@hcmut.edu.vn',
    phone: '038899xxxx',
  },
]
    ...
    <tr key={info.id}>
      ...
      <td className="text-center">
        ...
        <Button
          variant="danger"
          className="me-2"
          onClick={() => handleRemoveClick(info.id)}
        >
        ...
        >
          {loading ? (
            <Spinner
              animation="border"
              role="status"
              style={{ width: '4rem', height: '4rem', marginTop: '10vh' }}
            >
