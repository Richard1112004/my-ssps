                  ...
                  <div className="card-body p-0">
                    <ul className="list-group list-group-flush">
                      {paperLog
                        .sort(
                          (a, b) =>
                            new Date(b.purchase_time) -
                            new Date(a.purchase_time),
                        ...
                        .map((log) => (
                          <li className="list-group-item d-flex justify-content-between align-items-center p-3">
                            ...
                            <div>
                              ...
                              <strong>Price per unit:</strong> {log.price} VND
                              <br />
                              <strong>Total:</strong> ${log.total_amount} VND
                              <br />
                              <strong>Purchase Time:</strong>{' '}
                              {new Date(log.purchase_time).toLocaleString()}
                            </div>
                          </li>
                        ))}
                    </ul>
