  ...
  return (
    <div className="Container">
      <div className="MainContain">
        ...
        <div className="UploadContain">
          ...
          <div className="uploadStatus">
            <div className="statusContainer">
              ...
              {fileName && (
                <div className="statusIcon" onClick={handleRemoveFile}>
                  <img src={uploadFile} alt="trash" />
                </div>
              )}
            </div>
            {fileName && (
              <button className="button-rs" onClick={handleUpload}>
                Xác nhận
              </button>
            )}
          </div>
        ...
        <div className="configContainer">
          <div className="config1Container">
            ...
            <div className="select2">
              ...
              <select
                id="mySelect2"
                onChange={(e) => setSizePaper(e.target.value)}
              >
                <option value="">-- Chọn --</option>
            ...
            <div className="select3">
              ...
              <input
                ...
                id="mySelect3"
                placeholder="VD:1-10"
                onChange={(e) => setNumberPrint(e.target.value)}
              />
            </div>
            <div className="select4">
              ...
              <select
                id="mySelect4"
                onChange={(e) => setOptionPrint(e.target.value)}
              >
                <option value="">-- Chọn --</option>
        ...
        <button onClick={handleCancel} className="button-rs">
          Hủy bỏ
        </button>
      </div>
    </div>
